  ...
  return (
    <section className="relative mb-[65px] grid max-w-full grid-cols-[40%_60%] overflow-hidden max-[1025px]:grid-cols-1">
      ...
      <div className="relative col-start-2 min-h-[320px] max-[1025px]:col-auto max-[1025px]:min-h-[420px]">
        ...
        <div className="relative z-10 flex min-h-[520px] flex-col justify-between px-6 py-8 sm:px-[5vw] md:px-[50px] md:py-[7vw] md:pl-[60px]">
          <p className="mb-2 max-w-[680px] min-h-[91px] text-lg leading-[1.26] text-white sm:text-xl md:text-2xl">{subtitle}</p>
